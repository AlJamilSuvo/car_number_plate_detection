...
import os
import cv2
from Lib.utils import decode_netout, compute_overlap, compute_ap
from keras.applications.mobilenet import MobileNet
from keras.layers.merge import concatenate
from keras.optimizers import SGD, Adam, RMSprop
from Lib.preprocessing import BatchGenerator
from keras.callbacks import EarlyStopping, ModelCheckpoint, TensorBoard
from Lib.backend import TinyYoloFeature, FullYoloFeature, MobileNetFeature, SqueezeNetFeature, Inception3Feature, \
...
class YOLO(object):
    ...
    def test(self, test_images):
        ...
        test_generator = BatchGenerator(test_images,
                                        generator_config,
                                        norm=self.feature_extractor.normalize)
